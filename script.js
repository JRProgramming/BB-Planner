...
joey = []
 ...
 window.lengthj = joey.length
        ...
        {
        note.card.find(".mdl-card__title-text").html(note.title + "  <span style=\"text-decoration: underline; cursor:pointer; float:right;\" class=\"clearbutton\" id=\"" + classes + "buttonx\" onclick=\"clearHW()\">Clear HW</span>")
        }
        else
        {
